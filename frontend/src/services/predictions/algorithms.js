...
export class PredictionAlgorithms {
    ...
    static statisticalModel(input) {
        ...
        const opponentStrength = opponentData
            ...
            : 0.5;
        const predictedWinProbability = (winRate * 0.5 + recentForm * 0.3 + (1 - opponentStrength) * 0.2) * 100;
    ...
    static hybridModel(input) {
        ...
        const predictedWinProbability = statistical.predictedWinProbability * 0.6 + ml.predictedWinProbability * 0.4;
