import { fetchPrizePicksProps, fetchPrizePicksPlayer, optimizePortfolio, } from '../prizePicksService';
...
describe('PrizePicksService', () => {
    ...
    describe('fetchPrizePicksProps', () => {
        ...
        it('should apply filters correctly', async () => {
            ...
            expect(apiClient.get).toHaveBeenCalledWith(expect.stringContaining('/projections'), expect.objectContaining({
                params: {
                    league_id: 'NBA',
                    stat_type: 'points',
                },
