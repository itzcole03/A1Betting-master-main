...
jest.mock('@tanstack/react-query', () => ({
    ...
    QueryClientProvider: ({ children }) => _jsx(_Fragment, { children: children }),
}));
...
const renderApp = () => {
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(BrowserRouter, { children: _jsx(App, {}) }) }));
};
