...
describe('PrizePicksAPI Service', () => {
    ...
    describe('fetchProjections', () => {
        ...
        it('should fetch projections for a specific league', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(`${mockBaseUrl}/projections?single_stat=true&league_id=NFL`, expect.objectContaining({ method: 'GET' }));
        });
        ...
        it('should handle API key if provided in config', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(`${mockBaseUrl}/projections?single_stat=true&league_id=NBA`, expect.objectContaining({
                method: 'GET',
