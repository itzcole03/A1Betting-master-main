...
export const premiumTheme = {
    colors: {
        ...
        gradients: {
            ...
            premium: "linear-gradient(135deg, #8B5CF6 0%, #7C3AED 25%, #6D28D9 50%, #5B21B6 75%, #4C1D95 100%)",
            neon: "linear-gradient(135deg, #00D4AA 0%, #00A3FF 50%, #0066FF 100%)",
            sunset: "linear-gradient(135deg, #FF6B6B 0%, #FF8E53 25%, #FF6B35 50%, #F7931E 75%, #FFD93D 100%)",
        },
    },
    // Advanced Shadows;
    shadows: {
...
export const getThemeColor = (colorPath) => {
    ...
    const result = premiumTheme.colors;
