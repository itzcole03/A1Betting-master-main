...
const buttonVariants = cva("inline-flex items-center justify-center rounded-xl font-semibold transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none", {
    variants: {
        variant: {
            default: "bg-brand-500 text-white hover:bg-brand-600 focus:ring-brand-500 shadow-brandShadow hover:shadow-lg transform hover:scale-[1.02]",
            premium: "bg-gradient-to-r from-brand-500 to-brand-600 text-white hover:from-brand-600 hover:to-brand-700 shadow-brandShadow hover:shadow-xl transform hover:scale-105 active:scale-95",
            glass: "bg-white/20 backdrop-blur-lg border border-white/30 text-white hover:bg-white/30 hover:border-white/40 shadow-glass",
            outline: "bg-transparent border-2 border-brand-500 text-brand-500 hover:bg-brand-500 hover:text-white shadow-soft hover:shadow-brandShadow",
            success: "bg-gradient-to-r from-success-500 to-success-600 text-white hover:from-success-600 hover:to-success-700 shadow-successShadow",
            error: "bg-gradient-to-r from-error-500 to-error-600 text-white hover:from-error-600 hover:to-error-700 shadow-errorShadow",
            warning: "bg-gradient-to-r from-warning-500 to-warning-600 text-white hover:from-warning-600 hover:to-warning-700 shadow-warningShadow",
...
const cardVariants = cva("rounded-xl transition-all duration-300 ease-out", {
    variants: {
        variant: {
            ...
            premium: "bg-white/95 backdrop-blur-xl border border-white/20 shadow-xl hover:shadow-2xl hover:border-brand-500/30 transform hover:-translate-y-2",
            glass: "bg-white/10 backdrop-blur-xl border border-white/20 shadow-glass hover:bg-white/20 hover:border-white/30 transform hover:translate-y-[-2px]",
            gradient: "bg-gradient-to-br from-brand-500/10 via-brand-600/5 to-brand-700/10 backdrop-blur-xl border border-brand-500/20 shadow-brandShadow",
            neumorphic: "bg-gray-100 dark:bg-gray-900 shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff] dark:shadow-[20px_20px_60px_#0a0a0a,-20px_-20px_60px_#262626]",
        },
        padding: {
            none: "p-0",
            sm: "p-4",
...
const Card = React.forwardRef(({ className, variant, padding, rounded, ...props }, ref) => {
...
const inputVariants = cva("flex w-full transition-all duration-300 ease-out focus:outline-none disabled:cursor-not-allowed disabled:opacity-50", {
    variants: {
        variant: {
            default: "bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20",
            premium: "bg-white/90 backdrop-blur-lg border border-gray-200 text-gray-900 placeholder-gray-500 focus:bg-white focus:border-brand-500 focus:ring-4 focus:ring-brand-500/20",
            glass: "bg-white/10 backdrop-blur-lg border border-white/20 text-white placeholder-white/60 focus:border-white/40 focus:bg-white/20",
            minimal: "bg-transparent border-b-2 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-brand-500 rounded-none px-0",
        },
        inputSize: {
...
const Input = React.forwardRef(({ className, variant, inputSize, rounded, ...props }, ref) => {
