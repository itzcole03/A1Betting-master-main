...
describe.skip('PredictionExplanationModal', () => {
    ...
    it('does not render when open is false', () => {
        render(_jsx(PredictionExplanationModal, { open: false, prediction: mockPrediction, onClose: () => { } }));
    ...
    it('handles empty explanations array', () => {
        ...
        render(_jsx(PredictionExplanationModal, { open: true, prediction: emptyPrediction, onClose: () => { } }));
        expect(screen.getByText('Prediction Explanation')).toBeInTheDocument();
