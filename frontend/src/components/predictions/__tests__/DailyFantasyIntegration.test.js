...
describe.skip('DailyFantasyIntegration', () => {
    ...
    it('fetches data when API key is provided', async () => {
        ...
        expect(mockOnDataUpdate).toHaveBeenCalledWith(expect.arrayContaining([
    ...
    it('handles API errors gracefully', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith('Error fetching DailyFantasy data', expect.any(Object));
