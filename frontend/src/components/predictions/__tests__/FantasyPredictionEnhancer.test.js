...
describe.skip('FantasyPredictionEnhancer', () => {
    ...
    it('enhances predictions with fantasy data', async () => {
        render(_jsx(FantasyPredictionEnhancer, { fantasyData: mockFantasyData, predictions: mockPredictions, onEnhancedPredictions: mockOnEnhancedPredictions }));
        await waitFor(() => {
            expect(mockOnEnhancedPredictions).toHaveBeenCalledWith(expect.arrayContaining([
        ...
        expect(mockLogger.info).toHaveBeenCalledWith('Successfully enhanced predictions with fantasy data', expect.any(Object));
    ...
    it('handles missing fantasy data for predictions', async () => {
        ...
        render(_jsx(FantasyPredictionEnhancer, { fantasyData: mockFantasyData, predictions: predictionsWithMissingData, onEnhancedPredictions: mockOnEnhancedPredictions }));
        await waitFor(() => {
            expect(mockOnEnhancedPredictions).toHaveBeenCalledWith(expect.arrayContaining([
                expect.objectContaining({
                    playerId: '1',
    ...
    it('handles errors gracefully', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith('Error enhancing predictions', expect.any(Object));
