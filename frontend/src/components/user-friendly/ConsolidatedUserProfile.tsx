...
> = ({ onNavigate }) => {
  ...
  const [editedProfile, setEditedProfile] =
    useState<ExtendedUserProfile>(profile);
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl border border-green-500/20 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <button className="w-full px-4 py-3 text-left bg-gray-700/40 rounded-lg hover:bg-gray-700/60 transition-colors">
                    <div className="font-medium text-white">
                      Change Password
                    </div>
                    <div className="text-sm text-gray-400">
                  ...
                  <button className="w-full px-4 py-3 text-left bg-gray-700/40 rounded-lg hover:bg-gray-700/60 transition-colors">
                    <div className="font-medium text-white">Login Sessions</div>
                    <div className="text-sm text-gray-400">
