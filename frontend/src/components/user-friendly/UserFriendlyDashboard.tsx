        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <Eye className="w-4 h-4 text-electric-400 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <BarChart3 className="w-4 h-4 text-purple-400 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <TrendingUp className="w-4 h-4 text-blue-400 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <DollarSign className="w-4 h-4 text-green-400 ml-auto opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
          </div>
            ...
            <div className="flex items-center justify-between text-sm mt-2">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-20 h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div className="w-full h-full bg-gradient-to-r from-green-400 to-blue-400 rounded-full animate-pulse" />
                </div>
