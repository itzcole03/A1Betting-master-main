...
export declare class StrategyRegistry {
    ...
    evaluate<T, U>(strategyId: string, input: T, context: StrategyContext): Promise<StrategyResult<U>>;
    evaluateWithPipeline<T, U>(strategies: string[], input: T, context: StrategyContext): Promise<StrategyResult<U>>;
...
export declare class ComposableStrategy<T, U> implements StrategyComponent<T, U> {
    ...
    constructor(id: string, name: string, version: string, priority: number, dependencies: string[], evaluator: (input: T, context: StrategyContext) => Promise<U>, validator?: ((input: T) => Promise<boolean>) | undefined, handler?: ((input: T) => boolean) | undefined);
    evaluate(input: T, context: StrategyContext): Promise<U>;
    validate(input: T): Promise<boolean>;
    canHandle(input: T): boolean;
