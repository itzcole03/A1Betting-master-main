...
export declare function sanitizeObject<T extends Record<string, string | number | boolean | object>>(obj: T): T;
...
export declare function getRateLimitHeaders(remaining: number, reset: number): Record<string, string>;
