...
export function useRealtimePredictions({ enabled = true, channels = ["predictions", "market", "sentiment"], onError, reconnectAttempts: maxReconnectAttempts = 5, reconnectInterval = 5000, } = {}) {
